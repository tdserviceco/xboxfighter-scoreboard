...
$(document).ready(function () {
  ...
  socket.on('update', (data) => {
    ...
    if ($.isEmptyObject(game)) {
      ...
      .append('<link rel="mask-icon" href="/safari-pinned-tab.svg" color="#5bbad5">')
      .append('<meta name="msapplication-TileColor" content="#da532c">')
      .append('<meta name="theme-color" content="#0e7a0d">')
